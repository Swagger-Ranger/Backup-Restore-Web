...
'                <div class="tab-content"></div>'].join("");;
        ...
        var methods = {
            ...
            addTab: function (options) {
                ...
                if ((function () {
                        var ret = false;
                        nthTabs.find('.tab-pane').each(function (index, tab) {
            ...
            setExtDivWidth: function (width) {
                var extDiv = nthTabs.find('.ext-div');
                var tabsDiv = nthTabs.find('.tabs-div');
                //设置宽度
            ...
            locationTab: function (tabId) {
                ...
                //情况2：之前同级选项卡宽度之和大于选项卡可视区域的70%且小于等于选项卡可视区域的则margin为可视区域的一半,使其更显眼
                    ...
                    margin_left_total = 80 - settings.rollWidth / 2;
                }
                ...
                //即当前活动选项卡相对选项卡可视区域宽度的(余宽) = a+b-Math.floor(a/c)*c
                    ...
                    if (remaining <= settings.rollWidth * 0.7) {
                        ...
                        margin_left_total = 80 - Math.floor(width / settings.rollWidth) * settings.rollWidth;
                    } else {
                        //余宽大于选项卡可视区域宽度70%则边距为可视区域宽度的整数倍外加一半的边距，保证活动选项卡可视效果最佳
                        margin_left_total = 80 - Math.floor(width / settings.rollWidth) * settings.rollWidth - settings.rollWidth / 2;
                    }
                }
            ...
            delOtherTab: function () {
                ...
                nthTabs.find(".tab-content div").each(function (i, item) {
        ...
        var event = {
            ...
            onClickNavIcon: function () {
                nthTabs.on('click', '.roll-nav-icon', function () {
